...
export class ListingUser1581955624470 implements MigrationInterface {
    name = 'ListingUser1581955624470'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "listings" ALTER COLUMN "ownerId" SET NOT NULL`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "listings" ALTER COLUMN "ownerId" DROP NOT NULL`, undefined);
